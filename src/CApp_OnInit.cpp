...
//    this->voronoi_graph->AddNode(new VoronoiNode(180,120,255,255,255));
    ...
    double gain = 0.2/std::sqrt(this->media_texture->GetWidth()*this->media_texture->GetHeight()/node_count); // higher gain => higher sharpness / smaller gain => higher smoothness
