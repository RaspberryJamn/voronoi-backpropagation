...
class VoronoiGraph {
    public:
        ...
        NodeLinkedList* GetNearby(double x, double y, double band_width, VoronoiNode* seed); // closest node is at the top, the neg square dist of everything else is no less than the nearest dist minus the band width
